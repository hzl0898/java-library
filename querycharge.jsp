...
<body>
	<nav class="breadcrumb">
		<i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>业主缴费管理 <span class="c-gray en">&gt;</span> 业主缴费查询 <a
	...
	<div class="page-container">
		<table class="table table-border table-bordered table-bg">
			<thead>
				<tr>
					<th scope="col" colspan="5">业主缴费查询</th>
				</tr>
				<tr class="text-c">
					<th class="center">收费单</th>
					<th class="center">业主</th>
		...
		<div class="text-c">
			<form action="charge/queryChargeByCond.action" name="myform" method="post">
				查询条件： <span class="select-box" style="width: 200px;"><select name="cond" class="select">
						<option value="moneyid">按收费单查询</option>
						<option value="usersid">按业主查询</option>
